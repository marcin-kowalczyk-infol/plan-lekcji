...
- Dane w kolumnie JSON zachowują starszy format tablicy zajęć przy odczycie. Nowe zapisy używają obiektu `{events, dayEscorts}`. Brak nowych pól w żądaniu starszego klienta zachowuje istniejące wpisy; jawny pusty tekst je usuwa. Kopie JSON obejmują nowe pola.
