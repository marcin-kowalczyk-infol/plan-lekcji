...
## Coding conventions
Use ESM and small functions; keep local and production API behavior aligned. Maintain current dependency and migration files. Record behavioral changes in README. Preserve all five days in the mobile full-week view; day shortcuts scroll without hiding other days. There is no multi-bot runtime.
